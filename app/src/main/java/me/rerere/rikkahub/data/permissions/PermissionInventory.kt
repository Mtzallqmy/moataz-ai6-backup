...
object PermissionInventory {
        ...
        when (perm) {
            Manifest.permission.SYSTEM_ALERT_WINDOW -> {
                ...
                return Row(
                    ...
                    description = "Lets Moataz AI draw the \"agent is working\" overlay while automation is in progress.",
    ...
    private val DESCRIPTIONS = mapOf(
        ...
        "com.termux.permission.RUN_COMMAND" to "Lets Moataz AI start commands inside Termux for the termux_run_command tool.",
    )

...
val releaseSigningFile = rootProject.file("local.properties")
...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 37
        versionCode = providers.gradleProperty("MOATAZ_VERSION_CODE").orNull?.toIntOrNull() ?: 1
        versionName = providers.gradleProperty("MOATAZ_VERSION_NAME").orNull ?: "0.1.0"
    ...
    signingConfigs {
        if (hasReleaseSigning) {
            ...
            logger.warn("Release signing is not configured; release APK/AAB will be built unsigned")
        }
    }
